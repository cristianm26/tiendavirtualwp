	...
	class CR_Trust_Badge
	{
		...
		*/
		...
		public function show_trust_badge()
		{
			...
			if( 'wdp' === $this->shortcode_atts['type'] ) {
				...
				$return .= '<img id="ivole_trustbadgefi_' . $this->shortcode_atts['type'] . '" class="' . $class_img . '" width="486" height="198" src="' . 'https://www.cusrev.com/badges/' . Ivole_Email::get_blogurl() . '-' . $this->shortcode_atts['type'] . $l_suffix . '.png' . $color . '" alt="' . __( 'Trust Badge', 'customer-reviews-woocommerce' ) . '">';
			} elseif ( 'vsl' === $this->shortcode_atts['type'] || 'vsd' === $this->shortcode_atts['type'] ) {
				$return .= '<img id="ivole_trustbadgefi_' . $this->shortcode_atts['type'] . '" class="' . $class_img . '" width="560" height="120" src="' . 'https://www.cusrev.com/badges/' . Ivole_Email::get_blogurl() . '-' . $this->shortcode_atts['type'] . $l_suffix . '.png' . $color . '" alt="' . __( 'Trust Badge', 'customer-reviews-woocommerce' ) . '">';
			} else {
				$return .= '<img id="ivole_trustbadgefi_' . $this->shortcode_atts['type'] . '" class="' . $class_img . '" src="' . 'https://www.cusrev.com/badges/' . Ivole_Email::get_blogurl() . '-' . $this->shortcode_atts['type'] . $l_suffix . '.png' . $color . '" alt="' . __( 'Trust Badge', 'customer-reviews-woocommerce' ) . '">';
			}
			$return .= '</a></div>';
		...
		*/
		public static function render_block( $block_attributes ) {
			...
			$return .= '<a href="https://www.cusrev.com/' . $site_lang . 'reviews/' . $verified_reviews_page . '" rel="nofollow noopener noreferrer" target="_blank"><img id="ivole_trustbadgefi_' . $badge_type . '" class="' . $class_img . '"' . $wh . ' src="' . $badge_img_src . '"' . $color . ' alt="' . __( 'Trust Badge', 'customer-reviews-woocommerce' ) . '"></a>';
			$return .= '</div>';
