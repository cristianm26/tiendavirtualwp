	...
	class CR_Shortcodes_Settings {
		...
		*/
		...
		public function show_shortcodes( $value ) {
			...
			'shop_reviews="false" count_shop_reviews="1" inactive_products="false" avatars="true" show_more="0" min_chars="0"]</code></p>' .
			'<p class="cr-admin-shortcodes"><b>' . __( 'Parameters:', 'customer-reviews-woocommerce' ) . '</b></p>' .
			'<ul>' .
			...
			'products="" color_brdr="#ebebeb" color_bcrd="#fbfbfb" color_pr_bcrd="#f2f2f2" color_stars="#6bba70" shop_reviews="false" count_shop_reviews="1" inactive_products="false" autoplay="false" avatars="true" max_chars="0" min_chars="0"]</code></p>' .
			'<p class="cr-admin-shortcodes"><b>' . __( 'Parameters:', 'customer-reviews-woocommerce' ) . '</b></p>' .
			'<ul>' .
